...
ConfigPage {
    ...
    Kirigami.FormLayout {
        ...
        ComboBox {
            ...
            currentIndex: cfg_page.cfg_wheelEnabled
            onActivated: (index) => cfg_page.cfg_wheelEnabled = index
        }
        ...
        RowLayout {
            ...
            CheckBox {
                ...
                enabled: wheelEnabled.currentIndex === 1 || wheelEnabled.currentIndex === 2
